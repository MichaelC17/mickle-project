      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-text-muted leading-relaxed">
              The marketplace for paid creator collaborations. Grow your channel faster.
            </p>
            
            {/* Social Links */}
            <div className="flex items-center gap-3 mt-6">
              <a href="#" className="w-10 h-10 rounded-full bg-surface-raised flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-border transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/browse" className="text-text-muted hover:text-text-primary transition-colors">
                  Browse Creators
                </Link>
              </li>
              <li>
          ...
          {/* For Creators */}
          <div>
            <p className="text-sm font-semibold text-text-primary mb-4">For Creators</p>
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/apply" className="text-text-muted hover:text-text-primary transition-colors">
                  Become a Host
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-text-muted">
            <a href="mailto:hello@collab.io" className="hover:text-text-primary transition-colors">
              hello@collab.io
            </a>
          </div>
        </div>
